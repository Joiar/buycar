...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('Loans/pcList');?>" data-title="pc端贷款管理" href="javascript:void(0)">汽车贷款管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-setting">
			...
			<dd>
				<ul>
					<li><a data-href="<?php echo U('Config/index');?>" data-title="配置管理" href="javascript:void(0)">配置管理</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/buyCar/Public/Admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
